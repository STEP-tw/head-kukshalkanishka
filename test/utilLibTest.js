...
describe("parseInput", function() {
  ...
  it("should return an object with option as undefined when there is no option specified", function() {
    let expectedOutput = {option : undefined, numericOption: 3, filePaths: ["file1"]};
  ...
  it("should return an object when option as (n) when first index is (-n3)", function() {
    let expectedOutput = {option : "-n", numericOption: 3, filePaths: ["file1"]};
    assert.deepEqual(parseInput(["-n3", "file1"]), expectedOutput);

  });

  it("should return an object with option and numericOption as undefined when array only has a file name", function() {
    let expectedOutput = {option : undefined, numericOption: undefined, filePaths: ["file1"]};
